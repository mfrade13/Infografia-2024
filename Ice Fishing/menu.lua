...
local scene = composer.newScene()
 ...
 local bckg, btn_play, logo, btn_instructions

 local backgroundmusic

backgroundmusic = audio.loadStream( res_folder .. "Ice Fishing.mp3")
...
-- -----------------------------------------------------------------------------------
 ...
 function open_instructions(e)
    if e.phase == "ended" then
        ...
        composer.showOverlay( "instrucciones" , options )
    end
